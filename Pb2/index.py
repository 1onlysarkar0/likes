...
# Change to root directory so Flask can find templates and static files
os.chdir(root_dir)

# Set environment variable to disable background service on Vercel
...
# AES Keys
AES_KEY_STR = os.getenv('AES_ENCRYPTION_KEY', 'Yg&tc%DEuh6%Zc^8')
AES_IV_STR = os.getenv('AES_ENCRYPTION_IV', '6oyZDr22E3ychjM%')
...
def api_info():
    return jsonify({
        ...
        "note": "Background token refresh not available on Vercel",
        "endpoints": {
